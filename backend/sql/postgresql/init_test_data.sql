...
(37, 'delete', 'DeleteLoginLog', null, 0, null, 2, null, 'log:login:del', 1, 0, 1, '', null, 36, '2025-06-26 20:29:06', null),
(38, 'clear', 'EmptyLoginLog', null, 0, null, 2, null, 'log:login:clear', 1, 0, 1, '', null, 36, '2025-06-26 20:29:06', null),
...
(40, 'delete', 'DeleteOperaLog', null, 0, null, 2, null, 'log:opera:del', 1, 0, 1, '', null, 39, '2025-06-26 20:29:06', null),
(41, 'clear', 'EmptyOperaLog', null, 0, null, 2, null, 'log:opera:clear', 1, 0, 1, '', null, 39, '2025-06-26 20:29:06', null),
...
(46, 'project', 'Project', '/fba', 5, 'https://wu-clan.github.io/picx-images-hosting/logo/fba.png', 0, null, null, 1, 1, 1, '', null, null, '2025-06-26 20:29:06', null),
(47, 'document', 'Document', '/fba/document', 1, 'lucide:book-open-text', 4, '/_core/fallback/iframe.vue', null, 1, 1, 1, 'https://fastapi-practices.github.io/fastapi_best_architecture_docs', null, 46, '2025-06-26 20:29:06', null),
...
values
(1, 'This departments data permission', 1, now(), null),
(2, 'Data permissions for testing department and below', 1, now(), null),
(3, 'Only personal data permission', 1, now(), null),
(4, 'Full model department data permission', 1, now(), null),
(5, 'Exclude super administrator data permissions', 1, now(), null);

insert into sys_data_rule (id, name, model, "column", operator, expression, "value", created_time, updated_time)
values
(1, 'Department ID is equal to the current user department', 'Dept', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(2, 'Department name equals test', 'Dept', 'name', 1, 0, 'test', now(), null),
(3, 'Parent department ID is equal to test department ID', 'Dept', 'parent_id', 0, 0, '1', now(), null),
(4, 'The creator is equal to the current user', '__ALL__', '__created_by__', 0, 0, '${user_id}', now(), null),
(5, 'The whole model department ID is equal to the current user department', '__ALL__', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(6, 'User is not a super administrator', 'User', 'is_superuser', 0, 1, '1', now(), null);
