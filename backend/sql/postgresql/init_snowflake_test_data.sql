...
values (2048601264366944256, 'Test', 0, null, null, null, 1, false, null, now(), null);
...
values
(2048601269932785664, 'Department name equals test', 'Dept', 'name', 1, 0, 'Test', now(), null),
(2048601269999894528, 'Parent department ID equals 1', 'Dept', 'parent_id', 0, 0, '1', now(), null);
