...
values (2048601269345583104, 'Test', 1, true, null, now(), null);
...
values
(2048601269672738816, gen_random_uuid(), 'admin', 'User88888', '$2b$12$8y2eNucX19VjmZ3tYhBLcOsBwy9w1IjBQE4SSqwMDL5bGQVp2wqS.', decode('24326224313224387932654E7563583139566A6D5A33745968424C634F', 'hex'), 'admin@example.com', 1, true, true, true, null, null, now(), now(), now(), 2048601264366944256, now(), null),
(2049946297615646720, gen_random_uuid(), 'test', 'User66666', '$2b$12$BMiXsNQAgTx7aNc7kVgnwedXGyUxPEHRnJMFbiikbqHgVoT3y14Za', decode('24326224313224424D6958734E514167547837614E63376B56676E7765', 'hex'), 'test@example.com', 1, false, false, false, null, null, now(), now(), now(), 2048601264366944256, now(), null);
...
values
(2048601269806956544, 'Data permissions of this department', 1, now(), null),
(2048601269869871104, 'Data permissions for departments and below', 1, now(), null),
(2048601269869871105, 'Only my data permission', 1, now(), null),
(2048601269869871106, 'Full model data permissions for this department', 1, now(), null),
(2048601269869871107, 'Exclude super administrator data permissions', 1, now(), null);

insert into sys_data_rule (id, name, model, "column", operator, expression, "value", created_time, updated_time)
values
(2048601269932785664, 'Department ID equals the current user department', 'Dept', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(2048601269999894528, 'Department name equals test', 'Dept', 'name', 1, 0, 'test', now(), null),
(2048601269999894529, 'The parent department ID is equal to the test department ID', 'Dept', 'parent_id', 0, 0, '1', now(), null),
(2048601269999894530, 'The creator is equal to the current user', '__ALL__', '__created_by__', 0, 0, '${user_id}', now(), null),
(2048601269999894531, 'The full model department ID is equal to the current user department', '__ALL__', '__dept_id__', 0, 0, '${dept_id}', now(), null),
(2048601269999894533, 'User is not a super administrator', 'User', 'is_superuser', 0, 1, '1', now(), null);
