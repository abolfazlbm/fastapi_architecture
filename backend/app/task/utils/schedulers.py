...
class ModelEntry(ScheduleEntry):
    ...
    def __init__(self, model: TaskScheduler, app=None) -> None:  # noqa:ANN001,C901
        ...
        try:
            ...
            logger.error(f'Disable task with parameter error: {self.name}; error: {exc!s}')
            asyncio.create_task(self._disable(model))
...
class DatabaseScheduler(Scheduler):
    ...
    def sync(self) -> None:
        ...
        try:
            ...
            logger.warning(f'DatabaseScheduler InterfaceError: {e!s}, wait for the next call to try again...')
        finally:
