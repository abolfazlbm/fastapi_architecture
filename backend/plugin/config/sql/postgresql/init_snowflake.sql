...
(2069061886627938312, 'Password incorrect lock duration', 'USER_SECURITY', 'USER_LOCK_SECONDS', '300', false, null, now(), null),
...
(2069061886627938314, 'Password expiration reminder', 'USER_SECURITY', 'USER_PASSWORD_REMINDER_DAYS', '7', false, '0 means no reminder', now(), null),
(2069061886627938315, 'Number of pass history checks', 'USER_SECURITY', 'USER_PASSWORD_HISTORY_CHECK_COUNT', '3', false, null, now(), null),
...
(2069061886627938318, 'Pass must contain special char', 'USER_SECURITY', 'USER_PASSWORD_REQUIRE_SPECIAL_CHAR', 'false', false, null, now(), null),
