...
@router.get(
    ...
    description='After Github authorization, it will automatically redirect to the current address and obtain user information, and automatically create system users through user information',
