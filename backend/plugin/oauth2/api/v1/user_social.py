...
@router.get('/me/bindings', summary='Get the user’s bound social account', dependencies=[DependsJwtAuth])
...
@router.get('/me/binding', summary='Get binding authorization link', dependencies=[DependsJwtAuth])
...
@router.delete('/me/unbinding', summary='Unbind the user’s social account', dependencies=[DependsJwtAuth])
